...
try {
    ...
    $mail->Username   = 'grgs95859@gmail.com';                     //SMTP username
    $mail->Password   = 'parkourparkour';                               //SMTP password
    ...
    $mail->Body    = 'Recuperación de la contraseña solicitada, <br><b>Haz click en el siguiente enlace para cambiar tu contraseña:</b><br>'.'http://localhost/sysvisitas/cambiarpassword.php?id='.$row['idusuario'].'';
