	...
	<div class="bg-ligth" style="width: 100%;">
		...
		<div class="row justify-content-center" style="width: 100%;">
			<div class=" bg-light rounded my-2 mx-2 ml-1" style="width: 98%;padding: 20px 0px 20px 30px;">
				<h4 class="text-center text-dark pt-2">Diligencias</h4>
			    <div style="width: 100%;">
				...
				?>
			      ...
			      <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			          ...
			          <div class="modal-content">
			            ...
			            <form action="agregarvisita.php" method="POST">
			              <div class="modal-body row">
			                ...
			                <div class="mb-3 col-6 form-check" style="margin-left: 40%;margin-top: 15px;">
				    ...
				    <form action="diligencias/reporte.php" method="post">
					...
					<tbody>
						<?php
							if (isset($_POST['buscarf'])==true) {
								...
								$where = "WHERE fecha_hora_ingreso BETWEEN '$ingb' AND '$salb'";
								$sqlbq="SELECT * FROM diligencias INNER JOIN usuario ON diligencias.idusuario = usuario.idusuario $where";
							}else{
						...
						?>
						<tr>
							<th scope="row" style=""><?php echo $row['id_diligencia']; ?></th>
				            <td style=""><?php echo $row['nombre']." ". $row['apellidos']; ?></td>
				            <td style=""><?php echo $row['fecha_hora_ingreso']; ?></td>
				            <td style=""><?php echo $row['motivo']; ?></td>
				            <td style=""><?php echo $row['tiempo']; ?></td>
				            <td style=""><?php echo $row['fecha_hora_retorno']; ?></td>
				            <td style=""><?php echo $row['descripcion']; ?></td>
