...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <div class="container-login100" style="width: 80%;margin-left: 10%; margin-top: 150px;">
    <div class="wrap-login100 p-l-20 p-r-30 p-t-10 p-b-30">
      ...
      <form action="" method="POST">
        <p class="h4">Eliminar Nivel de <?php echo $fila['nivel']; ?>.</p>
        <a href="index.php" class="btn btn-secondary">Cancelar</a>
        <input type="submit" class="btn btn-danger" name="eliminar" value="Eliminar">
        <?php
          $idmu=$_GET['id'];
            if (isset($_POST['eliminar'])) {
              $eliminar="DELETE FROM niveles WHERE idnivel='$id'";
