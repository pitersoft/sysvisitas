  ...
  <body>
    ...
    <div class="wrap-login100 p-l-20 p-r-30 p-t-10 p-b-30">
      ...
      <form action="" method="POST">
        <p class="h4">Eliminar Diligencia N° <?php echo $fila['id_diligencia']; ?> de usuario <?php echo $fila['nombre']." ".$fila['apellidos']; ?>.</p>
        <a href="index.php" class="btn btn-secondary">Cancelar</a>
        <input type="submit" class="btn btn-danger" name="eliminar" value="Eliminar">
        <?php
          $idmu=$_GET['id'];
            if (isset($_POST['eliminar'])) {
              $eliminar="DELETE FROM diligencias WHERE id_diligencia='$id'";
